...
var SESSION_MENU_ITEM_COUNT = 3;
var isSessionNode = (value) => {
  if (typeof value !== "object" || value === null) return false;
  const node = value;
  return typeof node["id"] === "string" && typeof node["title"] === "string" && typeof node["updatedAt"] === "number" && typeof node["blank"] === "boolean" && typeof node["running"] === "boolean";
};
var fiberOf = (element) => {
...
var sessionIdFromMenu = (element) => {
  let fiber = fiberOf(element);
  while (fiber !== null && fiber !== void 0) {
    const props = fiber.memoizedProps;
    if (props !== void 0 && isSessionNode(props.node)) return props.node.id;
    fiber = fiber.return;
  }
  return void 0;
};
